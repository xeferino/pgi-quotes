  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Editar de Datos de la Cita: <img src="{{ asset('img/loading.GIF') }}" alt="" style="width: 32px;margin-left: 10px;display: none;" id="load_cargar_data_editar"></h4>
      </div>
      <div class="modal-body">
        <div v-if="dataShowModalDataQuote.on==true">
              ...
              <table class="table table-hover tb">
                ...
                <tbody>
                  ...
                  <tr>
                    <th>
                      <div class="form-group fc">
                        <textarea class="form-control check-key" placeholder="Ingrese la descripción de la cita" name="description" value="{{ old('description') }}" required autofocus cols="15" rows="5" v-model="dataShowModalDataQuote.description"></textarea>
                      </div>
                    </th>
                    <th>
                  ...
                  <tr>
                    <th>
                      <div class="form-group fc">
                        <textarea class="form-control check-key" placeholder="Ingrese la observación de seguimiento" name="observation" value="{{ old('description') }}" required autofocus cols="15" rows="5" v-model="dataShowModalDataQuote.observation"></textarea>
                      </div>
                    </th>
                    <th>
         ...
         <input type="hidden" value="{!! csrf_token() !!}" id="token_edit_quote">
      ...
      <div class="modal-footer">
       <img src="{{ asset('img/loading.GIF') }}" alt="" style="width: 32px;margin-right: 10px; display: none" id="load_editar_quote">
