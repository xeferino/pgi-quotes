  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Editar de Cuenta de Usuario: <img src="{{ asset('img/loading.GIF') }}" alt="" style="width: 32px;margin-left: 10px;display: none;" id="load_cargar_data_editar"></h4>
      </div>
      <div class="modal-body">
        <div v-if="dataShowModalDataUser.on==true">
         ...
         <input type="hidden" value="{!! csrf_token() !!}" id="token_edit_user">
      ...
      <div class="modal-footer">
       <img src="{{ asset('img/loading.GIF') }}" alt="" style="width: 32px;margin-right: 10px; display: none" id="load_editar_user">
