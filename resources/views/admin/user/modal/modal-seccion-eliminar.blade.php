  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Eliminar Sección: <img src="{{ asset('img/loading.GIF') }}" alt="" style="width: 32px;margin-left: 10px;display: none;" id="load_cargar_seccion_eliminar">
      ...
      <div class="modal-body">
        <div v-if="dataShowModalDataSeccion.on == true">
          ...
          <input type="hidden" value="{!! csrf_token() !!}" id="token_eliminar_seccion">
        </div>
        <div v-else>
      ...
      <div class="modal-footer">
       <img src="{{ asset('img/loading.GIF') }}" alt="" style="width: 32px;margin-right: 10px; display: none" id="load_eliminar_seccion">
