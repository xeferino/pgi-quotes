  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Modificar Rol a Usuario: <img src="{{ asset('img/loading.GIF') }}" alt="" style="width: 32px;margin-left: 10px;display: none;" id="load_cargar_data"> <b>@{{ dataShowModalModificar.name }}</b></h4>
      </div>
      <div class="modal-body">
        <div v-if="dataShowModalModificar.rol!=''">
          ...
          <input type="hidden" value="{!! csrf_token() !!}" id="token_rol_mod">
        </div>
      ...
      <div class="modal-footer">
        <img src="{{ asset('img/loading.GIF') }}" alt="" style="width: 32px;margin-right: 10px; display: none" id="load_guardar_rol">
