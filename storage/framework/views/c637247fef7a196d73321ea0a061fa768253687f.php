  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Eliminar Usuario: <img src="<?php echo e(asset('img/loading.GIF')); ?>" alt="" style="width: 32px;margin-left: 10px;display: none;" id="load_cargar_data_eliminar">
      ...
      <div class="modal-body">
        <div v-if="dataShowModalDataUser.name!=''">
          ...
          <input type="hidden" value="<?php echo csrf_token(); ?>" id="token_eliminar_user">
        </div>
        <div v-else>
      ...
      <div class="modal-footer">
       <img src="<?php echo e(asset('img/loading.GIF')); ?>" alt="" style="width: 32px;margin-right: 10px; display: none" id="load_eliminar_user">
