            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                	<div id="app-crear">
	                	...
	                	<input type="hidden" value="<?php echo csrf_token(); ?>" id="token_gDoc">
	                	<div class="row">
	                		<div class="col-md-2">
                	...
                	<div class="content-form" style="display: none;">
                		...
                		<input type="hidden" value="<?php echo csrf_token(); ?>" id="token_gDoc2">
...
<?php echo $__env->make('procesos.document.modal.enviar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script>
	    ...
	    var appCrearDoc = new Vue({
	    	...
	    	created: function(){
	    		...
	    		$.ajax({
	    			url: "<?php echo e(url('ajax/get/docs/all')); ?>",
	    			type: 'get',
	    			dataType: 'json',
	    		...
	    		onClickGuardarDatos: function(){
	    			...
	    			if(this.datosDoc.nroDoc!=""&&this.datosDoc.tDoc!=""&&this.datosDoc.asunto!=""&&this.datosDoc.referencia!=""&&this.datosDoc.destinatario!=""&&this.datosDoc.nameDoc!=""){
	    				$.ajax({
	    					...
	    					url: "<?php echo e(url('ajax/save/data/doc')); ?>",
	    					data: this.datosDoc,
	    					type: 'post',
	    					dataType: 'json',
	    					success: function(data){
	    						...
	    						date = new Date();
	    						var nameUser ='<?php echo e(Auth::user()->name); ?>';
		...
		function ajaxEnvioDoc(data){
			$.ajax({
	    		...
	    		url: '<?php echo e(url('ajax/savedoc/after')); ?>/'+$('#id_documento').val(),
	    		data: data,
	    		type: 'post',
	    		dataType: 'json',
	    		success: function(data){
