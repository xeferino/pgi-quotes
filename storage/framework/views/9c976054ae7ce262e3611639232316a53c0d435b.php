                        ...
                        <div class="col-md-4">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <ul class="list-group">
                                <a href="<?php echo e(url('dash/people/new')); ?>" class="list-group-item" id="people-new">Crear Nueva Persona</a>
                                <a href="<?php echo e(url('dash/people/list')); ?>" class="list-group-item" id="people-list">Lista de Personas</a>
                              </ul>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <ul class="list-group">
                                <a href="<?php echo e(url('dash/quote/new')); ?>" class="list-group-item" id="quote-new">Crear Nueva Cita</a>
                                <a href="<?php echo e(url('dash/quote/list')); ?>" class="list-group-item" id="quote-list">Lista de Citas</a>
                              </ul>
                            </div>
                          </div>
                        </div>
