                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control check-key" name="date" value="<?php echo e(date('Y-m-d').'T'.date('H:m')); ?>" min="<?php echo e(date('Y-m-d').'T'.date('H:m')); ?>" required autofocus>
                        </div>
                    </div>
