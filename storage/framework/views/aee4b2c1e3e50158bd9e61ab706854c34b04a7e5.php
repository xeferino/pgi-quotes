  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Eliminar Rol: <img src="<?php echo e(asset('img/loading.GIF')); ?>" alt="" style="width: 32px;margin-left: 10px;display: none;" id="load_cargar_rol_eliminar">
      ...
      <div class="modal-body">
        <div v-if="dataShowModalDataRol.name !=''">
          ...
          <input type="hidden" value="<?php echo csrf_token(); ?>" id="token_eliminar_rol">
        </div>
        <div v-else>
      ...
      <div class="modal-footer">
       <img src="<?php echo e(asset('img/loading.GIF')); ?>" alt="" style="width: 32px;margin-right: 10px; display: none" id="load_eliminar_rol">
