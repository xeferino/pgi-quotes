                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control check-key" name="date" id="date" value="<?php echo e(date('Y-m-d').'T12:00'); ?>" min="<?php echo e(date('Y-m-d').'T00:00'); ?>" required autofocus>
                                        </div>
                                    </div>
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data==1){
                        ...
                        setTimeout(() => { location.href = '<?php echo e(route('home')); ?>'; }, 1000);
                    }else if (data==2){
                        $("#myModalQuotesCreate").modal("hide");
                        $("#myModalQuotes").modal("hide");
                        $('.loading_modal_create').hide();
