                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="persons_id" class="form-control check-key">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control check-key"  placeholder="Ingrese el titulo de la cita" name="date" value="<?php echo e(old('date')); ?>" required autofocus>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('procesos.quotes.base-quotes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>